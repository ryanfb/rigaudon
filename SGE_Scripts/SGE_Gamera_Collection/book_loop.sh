...
# spellchecking 
qsub -N $SPELLCHECK_JOB_NAME -p -500 -hold_jid  $BLEND_JOB_NAME -b y -o $OUTPUT_DIR -e $ERROR_DIR -S /bin/bash -V /usr/bin/python $RIGAUDON_HOME/Scripts/read_dict5.py $DICTIONARY_FILE $TEXT_BLENDED/output*  $SPELLCHECK_FILE
